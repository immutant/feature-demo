(defproject demo "0.2.0-SNAPSHOT"
  ...
  :dependencies [[org.clojure/clojure "1.6.0"]
                 [org.immutant/immutant "2.x.incremental.185"]

                 ;; Or bring in the immutant jars piecemeal
                 ;; [org.immutant/caching    "2.x.incremental.185"]
                 ;; [org.immutant/messaging  "2.x.incremental.185"]
                 ;; [org.immutant/scheduling "2.x.incremental.185"]
                 ;; [org.immutant/web        "2.x.incremental.185"]
